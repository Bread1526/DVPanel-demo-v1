...
import CodeEditor from '@/components/ui/code-editor'; // Adjusted import path
import type { Snapshot } from './editor-dialog'; // Assuming Snapshot type will be in editor-dialog.tsx or a shared types file
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl md:max-w-4xl lg:max-w-5xl h-[80vh] flex flex-col p-0 rounded-2xl overflow-hidden">
        <DialogHeader className="p-4 border-b bg-muted/50 flex-shrink-0">
          ...
          <DialogDescription>
            Viewing snapshot from: {format(new Date(snapshot.timestamp), 'PP HH:mm:ss')} - Language: {snapshot.language}
          </DialogDescription>
        </DialogHeader>
